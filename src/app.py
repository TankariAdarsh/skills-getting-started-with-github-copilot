...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice skills and play competitive matches",
    ...
    "Debate Team": {
        "description": "Practice argument skills and compete in debate tournaments",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["sarah@mergington.edu", "matt@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science competitions and collaborate on STEM challenges",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
